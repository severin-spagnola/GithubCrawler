"""
train_classifier_v6.py — V6 LightGBM classifier with:
  - Repo-level holdout split (80/20 by file count, random_state=42) — same 220-repo holdout as V4/V5
  - Stage 1: binary C vs HDL classifier (unchanged from V5)
  ...
  - 6 new port_mismatch-specific features appended to extract_features
  - OOS classification report saved to v6_oos_report.json
  - Model saved to polaris_classifier_v6.pkl
"""
...
# 6. Save model
# ---------------------------------------------------------------------------
model_path = Path('/Users/severinspagnola/Desktop/GithubCrawler/polaris_classifier_v6.pkl')
...
oos_path = Path('/Users/severinspagnola/Desktop/GithubCrawler/v6_oos_report.json')
